...
Problem:
    ...
    Given a weighted digraph (directed graph), find the least-cost path from a given source to a given destination with exactly

Example:
        Edge.of(0, 6, -1), Edge.of(0, 1, 5), Edge.of(1, 6, 3), Edge.of(1, 5, 5),
        Edge.of(1, 2, 7), Edge.of(2, 3, 8), Edge.of(3, 4, 10), Edge.of(5, 2, -1),
        Edge.of(5, 3, 9), Edge.of(5, 4, 1), Edge.of(6, 5, 2),
        Edge.of(7, 6, 9), Edge.of(7, 1, 6)

=============================================================
Solution:
    - BFS and track edges visited.
